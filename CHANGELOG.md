...
### Added
- Add a "Skip to main content" link and proper ARIA landmark roles for accessibility compliance (#208).
- Tag/folder organization for saved history entries with inline tag editing and filtering (#215).
